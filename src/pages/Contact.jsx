    ...
    const handleSubmit = async (e) => {
        ...
        emailjs.send(serviceID, templateID, templateParams, publicKey)
            ...
            .catch((error) => {
                ...
                alert("Ops! Errore durante l'invio.");
            })
            .finally(() => {
    ...
    return (
        <main className="pt-40 pb-20 px-6 lg:px-12 w-full mx-auto max-w-7xl min-h-screen">
            <header className="mb-24 text-center">
                ...
                >
                    Parliamone, prima che l'idea scada. Sono sempre aperto a nuove collaborazioni. Compila il form o scrivimi: prometto di non rispondere con un "le faremo sapere".
                </motion.p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                >
                    <LiquidCard className="p-8 flex items-center gap-6">
                        ...
                        <div>
                            <span className="block text-xs font-mono text-zinc-500 uppercase tracking-widest mb-1">Dove puoi chiamarmi</span>
                    ...
                    <LiquidCard className="p-8 flex items-center gap-6">
                        ...
                        <div>
                            <span className="block text-xs font-mono text-zinc-500 uppercase tracking-widest mb-1">Dove abito</span>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="name" className="text-sm font-bold font-sans text-zinc-300">Nome *</label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                                        ...
                                        placeholder="Come dovrò salvarti in rubrica?"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="subject" className="text-sm font-bold font-sans text-zinc-300">Oggetto *</label>
                                <input
                                    type="text"
                                    id="subject"
                                    name="subject"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="message" className="text-sm font-bold font-sans text-zinc-300">Messaggio *</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    rows="5"
                                    ...
                                    onChange={handleChange}
                                    placeholder="Riassumi la tua idea in tre parole (se ci riesci)."
                            ...
                            >
                                <span className="relative z-10">{isSubmitting ? 'Invio in corso...' : "Diamo vita all'idea"}</span>
