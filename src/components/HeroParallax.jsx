                ...
                >
                    <div className="flex flex-col">
                        <motion.h1
                            ...
                            className="font-sans font-bold text-5xl md:text-7xl lg:text-8xl tracking-tighter leading-none"
                        >
                            FRA DESIGN & GROWTH HACKING
                        </motion.h1>
                    </div>
                    ...
                    >
                        Sono Alberto. Trasformo l'estetica in performance ottimizzando ogni pixel per la conversione. Ricerco costantemente la sintesi visiva, perché odio il disordine e, soprattutto, i font con le grazie usati senza un senso.                    </motion.p>
                    ...
                    >
                        <Link to="/works">
                            <MagneticButton className="bg-accent text-white hover:bg-rose-600">
                                Guarda i progetti
                            </MagneticButton>
                        </Link>
                        <Link to="/contact">
